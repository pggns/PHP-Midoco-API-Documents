...
class MidocoCrmProfile extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Documents\StructType\CrmCustomerDTO $midocoCrmCustomer = null, array $externalProfile = [], ?\Pggns\MidocoApi\Documents\StructType\ProfileAttributes $profileAttributes = null, array $midocoCrmCustomerLink = [], array $midocoFrequentFlyerNumber = [], array $midocoCrmAddress = [], array $midocoContactEntry = [])
    {
        $this

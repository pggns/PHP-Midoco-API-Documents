...
class GetSupplierResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Documents\StructType\MidocoSupplierType $midocoSupplier = null, ?\Pggns\MidocoApi\Documents\StructType\MidocoSupplierAddress $midocoSupplierAddress = null, array $midocoSupplierAccountAssign = [], array $midocoSupplierPaymentCondition = [])
    {
        $this

...
/**
 * This class stands for SellItemPrintSelectType StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SellItemPrintSelectType extends AbstractStructBase
{
    /**
     * The childrenIds
    ...
    /**
     * Constructor method for SellItemPrintSelectType
     * @uses SellItemPrintSelectType::setChildrenIds()
     * @uses SellItemPrintSelectType::setConfirmationGroup()
     * @uses SellItemPrintSelectType::setSelected()
     * @uses SellItemPrintSelectType::setNeedsInvoicePrint()
     * @uses SellItemPrintSelectType::setEditable()
     * @uses SellItemPrintSelectType::setItemId()
     * @uses SellItemPrintSelectType::setType()
     * @uses SellItemPrintSelectType::setSellingMode()
     * @uses SellItemPrintSelectType::setStatus()
     * @uses SellItemPrintSelectType::setSupplierId()
     * @uses SellItemPrintSelectType::setAtolIndex()
     * @uses SellItemPrintSelectType::setAbtaSection()
     * @uses SellItemPrintSelectType::setBookingId()
     * @uses SellItemPrintSelectType::setTotalPrice()
     * @uses SellItemPrintSelectType::setParentId()
    ...
    public static function validateChildrenIdsForArrayConstraintFromSetChildrenIds(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $sellItemPrintSelectTypeChildrenIdsItem) {
            // validation for constraint: itemType
            if (!(is_int($sellItemPrintSelectTypeChildrenIdsItem) || ctype_digit($sellItemPrintSelectTypeChildrenIdsItem))) {
                $invalidValues[] = is_object($sellItemPrintSelectTypeChildrenIdsItem) ? get_class($sellItemPrintSelectTypeChildrenIdsItem) : sprintf('%s(%s)', gettype($sellItemPrintSelectTypeChildrenIdsItem), var_export($sellItemPrintSelectTypeChildrenIdsItem, true));
            }
        }
     ...
     * @param int[] $childrenIds
     * @return \Pggns\MidocoApi\Documents\StructType\SellItemPrintSelectType
     */

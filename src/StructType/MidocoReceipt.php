...
class MidocoReceipt extends ReceiptDTO
{
     ...
     */
    protected array $MidocoReceiptPosition = [];
    /**
     ...
     */
    protected array $MidocoAdditionalInfoForReceipt = [];
    /**
     ...
     */
    public function __construct(array $midocoReceiptPosition = [], ?\Pggns\MidocoApi\Documents\StructType\MidocoDebitInfoForReceipt $midocoDebitInfoForReceipt = null, array $midocoAdditionalInfoForReceipt = [], ?\Pggns\MidocoApi\Documents\StructType\MidocoOnlinePaymentTransaction $midocoOnlinePaymentTransaction = null)
    {
        $this
     ...
     */
    public function setMidocoReceiptPosition(array $midocoReceiptPosition = []): self
    {
     ...
     * @return \Pggns\MidocoApi\Documents\StructType\MidocoReceipt
     */
    public function setMidocoAdditionalInfoForReceipt(array $midocoAdditionalInfoForReceipt = []): self
    {
        // validation for constraint: array

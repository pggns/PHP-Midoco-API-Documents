...
class GetExtraMFResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getExtraMFResponseMidocoMfItem) {
            ...
            if (!$getExtraMFResponseMidocoMfItem instanceof \Pggns\MidocoApi\Documents\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\Documents\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\Documents\StructType\GetExtraMFResponse
     */
